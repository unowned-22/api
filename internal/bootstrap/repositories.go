...
type Repositories struct {
	...
	Community        *postgresRepo.CommunityRepository
	...
	UserPost         *postgresRepo.UserPostRepository
	CommunityPost    *postgresRepo.CommunityPostRepository
	Feed             *postgresRepo.FeedRepository
}
...
func InitRepositories(pool *pgxpool.Pool) *Repositories {
	return &Repositories{
		...
		Community:        postgresRepo.NewCommunityRepository(pool),
		...
		UserPost:         postgresRepo.NewUserPostRepository(pool),
		CommunityPost:    postgresRepo.NewCommunityPostRepository(pool),
		Feed:             postgresRepo.NewFeedRepository(pool),
	}
}
