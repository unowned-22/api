...
func NewStoryPublishedHandler(f friendship.Repository, u usersettings.Repository, r notification.Repository, h *ws.Hub) *StoryPublishedHandler {
	return &StoryPublishedHandler{friendshipRepo: f, usersetRepo: u, notifRepo: r, hub: h}
}
