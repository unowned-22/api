...
// Bucket and user_settings provisioning has been moved to EmailVerifiedHandler so that
// storage resources are only allocated for users who have confirmed their address.
