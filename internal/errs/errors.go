...
var ErrCommunityForbidden = errors.New("forbidden: insufficient community role")
var ErrCommunitySlugTaken = errors.New("community slug is already taken")
var ErrAlreadyCommunityMember = errors.New("already a member of this community")
var ErrNotCommunityMember = errors.New("not a member of this community")
var ErrCannotRemoveCommunityOwner = errors.New("cannot remove or demote the community owner")
var ErrInvalidCommunityPayload = errors.New("invalid community payload")
var ErrPostNotFound = errors.New("post not found")
var ErrPostForbidden = errors.New("forbidden: cannot modify this post")
var ErrInvalidPostPayload = errors.New("invalid post payload")
var ErrInvalidStoryForCommunity = errors.New("community stories must have visibility=everyone")
var ErrConversationAlreadyLinked = errors.New("conversation already linked to a community")
var ErrPromoteRequiresGroupOrChannel = errors.New("only group or channel conversations can be promoted")
var ErrNotConversationOwner = errors.New("only the conversation owner may perform this action")
